...
export default function ProjectsPage() {
  return (
    <main className="bg-[#f8f5f1] min-h-screen text-black overflow-hidden">
      ...
      {/* Navbar */}
      <nav className="fixed top-0 left-0 w-full z-50 bg-black/60 backdrop-blur-2xl border-b border-white/10 shadow-2xl">
        ...
        <div className="max-w-7xl mx-auto flex justify-between items-center px-4 md:px-8 py-4">
          ...
          <div className="flex items-center gap-3 md:gap-4">
            ...
            <div>
              ...
              <p className="uppercase tracking-[0.25em] md:tracking-[0.35em] text-[8px] md:text-[10px] text-[#d6b98c] mt-1">
          ...
          {/* Nav Links */}
          <div className="flex items-center gap-4 md:gap-10 text-[10px] md:text-sm uppercase tracking-[0.15em] md:tracking-[0.2em] font-medium text-white overflow-x-auto whitespace-nowrap">
      ...
      {/* Hero Header */}
      <section className="relative pt-40 md:pt-52 pb-24 md:pb-32 text-center bg-black text-white overflow-hidden">

        {/* Glow */}
        <div className="absolute top-1/2 left-1/2 h-[300px] md:h-[500px] w-[300px] md:w-[500px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-[#d6b98c]/20 blur-[120px] animate-pulse"></div>
        ...
        >
          ...
          <p className="uppercase tracking-[0.35em] text-xs md:text-sm text-[#d6b98c] mb-5">
            Portfolio
          </p>

          <h1 className="text-4xl sm:text-5xl md:text-7xl font-extrabold leading-tight drop-shadow-[0_4px_20px_rgba(0,0,0,0.7)]">
          ...
          <p className="mt-6 text-sm md:text-lg text-gray-300 max-w-2xl mx-auto leading-relaxed">
            ...
            <div className="bg-white rounded-3xl overflow-hidden shadow-[0_15px_60px_rgba(0,0,0,0.12)] group">
              ...
              <div className="overflow-hidden">
                ...
                <img
                  ...
                  alt="Project"
                  className="h-[300px] md:h-[420px] w-full object-cover group-hover:scale-110 transition duration-700"
                />
